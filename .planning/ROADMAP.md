...
- [ ] 06-02-PLAN.md — Expansão: 6 eventos + KPIs (resolução/fallback/custo/latência p50-p99/DAU-MAU) + agregação BullMQ + retenção + /overview /performance /cost /conversations (Wave 2)
