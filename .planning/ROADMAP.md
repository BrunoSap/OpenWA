...
- [x] 08-01-PLAN.md — Tracer: 2 replicas + nginx sticky + health checks (Redis + Engine indicators) (Wave 1)
- [x] 08-02-PLAN.md — Expansion: NFS shared storage + 3+ replicas + distributed workers/WebSocket (Wave 2)
