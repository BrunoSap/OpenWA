-- database/migrations/014_task8_fixes_with_cleanup.sql
-- Task 8 fixes with data cleanup

BEGIN;

-- ═══════════════════════════════════════════════════════════
--  STEP 0: Clean up invalid test data
-- ═══════════════════════════════════════════════════════════

-- Nullify invalid CPFs (will be validated properly going forward)
...
BEGIN
    ...
    RAISE NOTICE '  - Invalid CPFs cleaned';
